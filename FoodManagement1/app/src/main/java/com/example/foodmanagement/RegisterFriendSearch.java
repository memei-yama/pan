...
public class RegisterFriendSearch extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.register_friend);

        //メールアドレス
        family_mail = (EditText) findViewById(R.id.editTextTextPersonName5);

        findViewById(R.id.button29).setOnClickListener(this);//検索ボタン
        findViewById(R.id.button28).setOnClickListener(this);//戻るボタン
    }
