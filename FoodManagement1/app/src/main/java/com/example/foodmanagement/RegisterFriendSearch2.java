//山﨑里沙,2022/12/29
//フレンドユーザを検索結果を表示するプログラム,これは使わない(RegisterFamilyで実装)
...
public class RegisterFriendSearch2 extends AppCompatActivity implements View.OnClickListener {
    //変数の定義
    ...
    public void onClick(View v) {
        //画面遷移用
        Intent check = new Intent(this, RegisterFriendCheck.class);
